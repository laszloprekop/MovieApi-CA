...
{
    Task<IEnumerable<MovieDto>> GetAllAsync(string? title, string? genre, int? year, string? actor);
    Task<PagedResult<MovieDto>> GetPageAsync(string? title, string? genre, int? year, string? actor,
